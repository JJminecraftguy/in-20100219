...
copy /Y target_teavm_javascript\javascript\EaglercraftX_indev-20100219_Offline_International.html client\Eaglercraft_Offline_JS.html
...
copy /Y target_teavm_wasm_gc\javascript_dist\Eaglercraft_indev-20100219_WASM-GC_Offline_Download.html client\Eaglercraft_Offline_WASM.html
