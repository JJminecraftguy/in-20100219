...
public final class ItemPickaxe extends ItemTool {
	...
	public final boolean canHarvestBlock(Block var1) {
		return var1 == Block.obsidian ? this.getHarvestLevel == 3 : (var1 != Block.blockDiamond && var1 != Block.oreDiamond ? (var1 != Block.blockGold && var1 != Block.oreGold ? (var1 != Block.blockSteel && var1 != Block.oreIron ? (var1.material == Material.rock ? true : var1.material == Material.iron) : this.getHarvestLevel > 0) : this.getHarvestLevel >= 2) : this.getHarvestLevel >= 2);
	}
}
